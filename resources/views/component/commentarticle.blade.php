...
<article class="p-6 mb-6 text-base bg-white rounded-lg @if($comment->parent_id != null) ml-6 lg:ml-12 @endif">
    ...
    <div class="flex items-center mt-4 space-x-4">
        ...
        <form method="post" action="/comment/article" class="hidden reply-input w-full">
            @csrf
            <div class="form-group">
                <input type="text" name="body" class="p-2 w-full text-sm text-gray-900  border  rounded-lg h-10 focus:ring-0 focus:outline-none   " />
...
@include('component.commentarticle', ['comments' => $comment->replies]) 
@endforeach